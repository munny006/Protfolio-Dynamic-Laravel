                    ...
                    @foreach($service as $row)
                     <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            ...
                            <i class="<?php echo $row->icon;?> fa-stack-1x fa-inverse"></i>
                        </span>
                ...
                <div class="row">
                    ...
                    <!-- Portfolio item 1-->
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $protfolio->id?>">
                                <div class="portfolio-hover">
                                    <div class="portfolio-hover-content"><i class="fas fa-plus fa-3x"></i></div>
                                </div>
                                <img class="img-fluid" src="{{url($protfolio->small_img)}}" alt="..." />
                            </a>
            ...
            <div class="container">
                ...
                <ul class="timeline">
                    ...
                    @foreach($abouts as $about)
                        <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="{{url($about->img)}}" alt="..." /></div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p class="item-intro text-muted">{{$protfolio->sub_title}}</p>
                                    <img class="img-fluid d-block mx-auto" src="{{url($protfolio->big_img)}}" alt="..." />
